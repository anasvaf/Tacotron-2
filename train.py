...
def prepare_run(args):
    ...
    terminal_train_log = os.path.join(log_dir, 'Terminal_train_log_{}'.format(run_name))
    os.makedirs(terminal_train_log, exist_ok=True)
    logging.debug(terminal_train_log)
...
def main():
    ...
    parser.add_argument('--GTA', default='True',
                        help='Ground truth aligned synthesis, defaults to True, only considered in '
                             'Tacotron synthesis mode')
    ...
    parser.add_argument('--wavenet_train_steps', type=int, default=500000,
